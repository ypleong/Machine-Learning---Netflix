...
\begin{figure}[hptb]
\centering
\includegraphics[width=0.73\textwidth, trim = 2cm 2.8cm 2cm 2.5cm, clip=true]{Popular_10_Movies.pdf}
...
\begin{figure}[hptb]
\centering
\includegraphics[width=0.8\textwidth, trim = 2cm 3cm 2cm 3cm, clip=true]{Three_Genres.pdf}
...
\begin{figure}[hptb]
\centering
\includegraphics[width=0.8\textwidth, angle =0, trim = 2cm 1cm 2cm 1cm, clip=true]{Mean_Genre_Variance.png}
